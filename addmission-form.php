...
$userpic=md5($upic).$extension;
  ...
  move_uploaded_file($_FILES["userpic"]["tmp_name"],"userimages/".$userpic);
    ...
    $query=mysqli_query($con, "insert into tbladmapplications(UserId,CourseApplied,FatherName,MotherName,DOB,regno,
    Nationality,districtname,Gender,Category,CorrespondenceAdd,PermanentAdd,Board,year,Institution,gpa, h_Board,h_year,h_Institution,h_gpa,Signature,UserPic)

     value('$uid','$coursename','$fathername','$mothername','$dob','$regno','$countryname','$districtname', '$gender','$category','$coradd','$peradd',
     '$board','$year','$Institution','$gpa','$h_board','$h_year','$h_Institution','$h_gpa' ,'$sign','$userpic')");
    if ($query) {
...
<head>
  ...
  <title> Sylhet International University Addmission Management System|| Addmission Form</title>
...
$query=mysqli_query($con,"select tbladmapplications.*, tblcountry.countryname, tbldistrict.districtname as district_name, tbluser.FirstName, tbluser.LastName
...
<th>HSC or equivalent:</th>
  ...
  <td><?php echo $row['h_year'];?></td>
   <td><?php echo $row['h_Institution'];?></td>
   <td><?php echo $row['h_gpa'];?></td>
</tr>
...
<div class="col-xl-4 col-lg-12">
 <fieldset>
  <h5> Birthday Reg. No:</h5>
   <div class="form-group">
   <input class="form-control white_bg" id="regno" name="regno"  type="text" required>
...
<div class="col-xl-4 col-lg-12">
      ...
      <div class="input-container">
        <input id="dob" type="date" name="dob" minlength="1" maxlength="64" placeholder=" " autocomplete="nope" required="required"></input>
        <span class="bar"></span>
      </div>
    </div>
...
<div class="col-xl-4 col-lg-12">
 <fieldset>
  <h5> Nationality      </h5>
   <div class="form-group">
   <select name='countryname' id="countryname" class="form-control white_bg" required="true">
...
<div class="col-xl-4 col-lg-12">
 <fieldset>
  <h5> District      </h5>
   <div class="form-group">
   <select name='districtname' id="districtname" class="form-control white_bg" required="true">
...
<tr>
<th>SSC or equivalent:</th>
<td>   <input class="form-control white_bg" id="board" name="board" placeholder="Board"  type="text" required></td>
<td>   <input class="form-control white_bg" id="year" name="year" placeholder="Year"  type="text" required></td>
<td>   <input class="form-control white_bg" id="Institution" name="Institution" placeholder="Name of the Institution"  type="text" required></td>
<td>   <input class="form-control white_bg" id="gpa" name="gpa" placeholder="GPA"  type="text" required></td>
</tr>
<tr>
<th>HSC or equivalent:</th>
<td>   <input class="form-control white_bg" id="h_board" name="h_board" placeholder="Board"  type="text" required></td>
<td>   <input class="form-control white_bg" id="h_year" name="h_year" placeholder="Year"  type="text" required></td>
<td>   <input class="form-control white_bg" id="h_Institution" name="h_Institution" placeholder="Name of the Institution"  type="text" required></td>
<td>   <input class="form-control white_bg" id="h_gpa" name="h_gpa" placeholder="GPA"  type="text" required></td>
</tr>
...
<div class="row" style="margin-top: 2%">
<div class="col-xl-6 col-lg-12">
<button type="submit" name="submit" value="submit" class="btn btn-info btn-min-width mr-1 mb-1">Submit</button>
</div>
</div>
 </div>
                </div>
...
<?php include('includes/footer.php');?>
  ...
  type="text/javascript"></script>
    <!-- Formatter end ../../../-->    <script src="app-assets/vendors/js/forms/extended/maxlength/bootstrap-maxlength.js"
  type="text/javascript"></script>
