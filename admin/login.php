...
<head>
  ...
  <title>  Sylhet International University Addmission Management System||Admin Login  </title>
  <link rel="shortcut icon" href="app-assets/images/siumainlogo.png"/>
...
data-open="click" data-menu="vertical-menu" data-col="1-column">
  <!-- fixed-top-->
   <nav>
           ...
           <img src="app-assets/images/siumainlogo.png" alt="Logo" style="width:60px;" class=""></a>
        ...
        <section class="flexbox-container">
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              ...
              <h4 style="font-weight: bold"> SIU Admin Login</h4>
                  </div>
                ...
                <div class="card-content">
                  ...
                  <form class="form-horizontal" action="" name="login"  method="post">
                      ...
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="username" id="username" class="form-control input-lg" placeholder="username"tabindex="5"  required>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <p style="color:white;">Copyright (C) - 2022 | Developed By  Siu Cse35 Mithu & Joy</p>
