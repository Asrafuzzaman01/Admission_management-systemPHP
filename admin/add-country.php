...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblcountry(countryname) value('$countryname')");
    if ($query) {
...
<head>
  ...
  <title>SIU  Addmission Management System | Add country</title>
...
<form name="country" method="post" >        
  ...
  <input class="form-control white_bg" id="countryname" type="text" name="countryname" required>
                          </div>
                        </fieldset>
                      </div>
                    </div>
