...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from tbluser where  (Email='$emailcon' || MobileNumber='$emailcon') && Password='$password' && status='active' ");
...
<head>
  <title> SIU Online Admission Management System || User Login
  </title>
 ...
 <nav>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <p style="color:white;">Copyright (C) - 2022 | Developed By <a ></a><strong>Mithu & Durjoy</strong> </a> </p>
    </p>
  </footer>
